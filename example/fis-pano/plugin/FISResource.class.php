...
class FISResource {
    ...
    public static $resMapUrls = array();
    ...
    public static function renderResponse($strContent, $smarty){
        ...
        if ($smarty->tpl_vars['fis_res_map_url']->value != '') {
            self::$resMapUrls = $smarty->tpl_vars['fis_res_map_url']->value;
        }
    ...
    public static function render($type){
        ...
        if ($type === 'js') {
            ...
            //resource Map
            if (!empty(self::$resMapUrls)) {
                $html .= '<script type="text/javascript" src="' . implode('"></script><script type="text/javascript" src="', (array)self::$resMapUrls) . '"></script>';
            } else {
                if ($resourceMap) {
